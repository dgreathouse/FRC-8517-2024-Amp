...
import frc.robot.commands.AmpDefaultCommand;
...
public class RobotContainer {
  ...
  private static final AmpSubsystem m_amp = new AmpSubsystem();
  private final AmpDefaultCommand m_ampDefaultCommand= new AmpDefaultCommand(m_amp);
  ...
  public RobotContainer() {
    m_amp.setDefaultCommand(m_ampDefaultCommand);
